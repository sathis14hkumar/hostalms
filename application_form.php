	...
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Application Form </h2>
			<div class="mail_grid_w3l">
				<form action="application_form.php?id=<?php if(isset($_GET['id'])) echo '?id='.$_GET['id']; ?>" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="hostel" placeholder="Hostel" value="<?php if(isset($_GET['id'])) echo '?id='.$_GET['id']; ?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
